...
export default function ResetPasswordPage() {
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    // Llama directamente a updateUser, confiando en que Supabase ya tiene la sesión
    ...
    // Cerramos la sesión para que el usuario inicie sesión con la nueva contraseña
